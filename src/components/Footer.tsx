...
import { Instagram, Twitter, LinkedinIcon as LinkedIn, Facebook } from 'lucide-react'
...
const socialLinks = [
    ...
    { href: 'https://twitter.com/ocelopticnetwork', icon: Twitter, label: 'Twitter', color: 'text-[#1DA1F2]' },
