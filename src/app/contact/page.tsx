                        ...
                        <div className="bg-white shadow-xl rounded-3xl p-8 border border-gray-100">
                            ...
                            <div className="space-y-4">
                                <div className="flex items-center gap-4">
                                    ...
                                    <span className="text-gray-600"> Ma. Perihelion, Ameenee Magu,
                                        <br />
                                        Male&apos;, Maldives
                                    </span>
                                </div>
                                <div className="flex items-center gap-4">
                                    ...
                                    <span className="text-gray-600">+960 925 925 4</span>
                                </div>
                                <div className="flex items-center gap-4">
                                    <Mail className="w-6 h-6 text-emerald-500 flex-shrink-0" />
                                    <span className="text-gray-600">akram@ocelopticnetwork.com</span>
                                </div>
                            </div>
                        </div>
                    </motion.div>
